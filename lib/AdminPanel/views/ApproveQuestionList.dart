...
class _AddedQuestionsListState extends State<ApproveQuestionsList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: GetBuilder<AddedQuestionsListController>(builder: ((questionController) {
          // if (questionController.questionModelList.length == 0) {
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                ...
                                dashboradCont.showApprovedList = false;
