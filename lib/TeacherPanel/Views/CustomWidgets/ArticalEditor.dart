...
class ArticalEditor extends StatefulWidget {
  @override
  _ArticalEditorState createState() => _ArticalEditorState();
}

class _ArticalEditorState extends State<ArticalEditor> {
  ...
  Future<void> _loadFromAssets() async {
    try {
      final result = await rootBundle.loadString('triviaLogo.json');
