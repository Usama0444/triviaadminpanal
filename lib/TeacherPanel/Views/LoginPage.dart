                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DotsIndicator(
                          dotsCount: 4,
                          position: loginController.dotIndex,
                          onTap: (val) {
                  ...
                  child: CarouselSlider(
                    ...
                    options: CarouselOptions(
                        ...
                        onPageChanged: ((index, reason) {
                          loginController.dotBtnState(index.toDouble());
                        })),
                    items: imageSliders,
                  ),
                ),
          ...
          SizedBox(
            ...
            child: Column(
              children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: TextField(
                          ...
                          obscureText: loginController.obxTxt,
                          decoration: InputDecoration(
                            border: InputBorder.none,
                            hintText: 'Password',
                            hintStyle: TextStyle(color: greyColor, fontSize: 20.sp),
                      ...
                      InkWell(
                        onTap: () {
                          loginController.obxTxtState();
                        },
                        child: Container(
                          width: 32.w,
                          height: 15.h,
                          child: loginController.obxTxt == false ? SvgPicture.asset('assets/eyeHide.svg') : SvgPicture.asset('assets/eyeShow.svg'),
                        ),
                      )
                    ],
                  ),
                ...
                InkWell(
                  onTap: () async {
                    await loginController.loginBtnClick();
                  },
                  child: MyContainer(
                      180.w,
                      60.h,
